...
!        cut off distance : 2.25 Angstrom 
        ...
        character(80)::pdbf,path,out1,out2
     ...
     1        irns(100),xs(100),ys(100),zs(100)
        ...
        print*,'Edited'
        write(*,812)adjustl(path)

        out1=adjustl(trim(path))//'/dsl.out'
        out2=adjustl(trim(path))//'/dsl.num'
...
812   format(a80)
        ...
        open (unit=2,file=out1)
        open (unit=3,file=out2)
