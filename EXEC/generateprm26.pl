...
in(siz,file=\"$path/amber_dummy.siz\")";
print OUT "
!=============================================================
! partial charges (replaces fort.12)
!=============================================================

in(crg,file=\"$path/amber.crg\")";
print OUT "
!=============================================================
...
!==============================================================";
print OUT "
out(modpdb,file=\"$path/$outpdb\")	! output charged assigned atomic coordinate file ";
print OUT "
!==============================================================
! generate phimap used in focussing (replaces fort.14) (binary)
!==============================================================

out(phi,file=\"$path/phimap.cube\",format=cube)";
print OUT "
!==============================================================
